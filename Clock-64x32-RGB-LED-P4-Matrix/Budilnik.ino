void getprbud()
{
  ...
  if (h == Hb[dow] &&  m == Mb[dow] && s == 00 && ModBYD[dow] == 1) {
    flagpbudik = 1;
    if (mel1 == 21 || mel2 == 21 || mel3 == 21 || mel4 == 21 || mel5 == 21 || mel6 == 21 || mel7 == 21) {
      wrb();
    } else {
      getByd();
    }
...
void getByd() {
  ...
  matrix.fillRect(0, 0, 64, 32, myBLACK);
  //if(mel1 == 21 || mel2 == 21 || mel3 == 21 || mel4 == 21 || mel5 == 21 || mel6 == 21 || mel7 == 21){FlagNr == 0;MNR == false;St();ModWEBR = 2;modWR = 1;}
  flagpbudik = 0;
  getRTCh(szTime);
  getRTCm(szTime);
}
