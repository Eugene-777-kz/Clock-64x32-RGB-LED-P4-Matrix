...
uint8_t frameDelay2 = 6;
uint8_t frameDelay3 = 6;
uint8_t frameDelay4 = 4;
uint8_t frameDelay5 = 6;
uint8_t frameDelay6 = 6;
uint8_t frameDelay7 = 6;
uint8_t frameDelay8 = 6;
uint8_t frameDelay9 = 4;
uint8_t frameDelay10 = 14;
uint8_t frameDelay11 = 14;
uint8_t frameDelay12 = 14;
uint8_t frameEff = 25;
uint8_t frameSkrull = 15;
int Y;//Громкость плеера.
int EQ = 0;//Эквалайзер.
...
int MPov6 = 0;
int MPov7 = 0;
const char* Nsst = "станция1,станция2,станция3,станция4,станция5,станция6,станция7,станция8,станция9,станция10,станция11,станция12";
String valuestan = "";
//String iStation = "";
