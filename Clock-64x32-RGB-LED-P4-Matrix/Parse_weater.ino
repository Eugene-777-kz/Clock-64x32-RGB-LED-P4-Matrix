...
void getWeatherData0() {
  ...
  if (displayForecastNow) {
    if (location_temp > 0) {
      texttemp = "+" ;
      weatherString +=  "Сейчас в г " + String(gorod) + ":" + " температура " + texttemp + String(location_temp, 1) + "\260" + "С";
    } else {
      weatherString +=  "Сейчас в г " + String(gorod) + ":" + " температура " + String(location_temp, 1) + "\260" + "С";
    }
