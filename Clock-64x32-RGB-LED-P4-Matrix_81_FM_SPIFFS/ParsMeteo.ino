void Meteo() {
  ...
  http.end();
    ...
    deserializeJson(doc, line);
     ...
     if(weathercode == 0){textcode = "Ясно";location_code = 800;}
     if(weathercode == 1){textcode = "Преимущественно ясно";location_code = 801;}
     if(weathercode == 2){textcode = "переменная облачность";location_code = 802;}
     if(weathercode == 3){textcode = "плотная облачность";location_code = 804;}
     if(weathercode == 45){textcode = "Туман";location_code = 701;}
     if(weathercode == 48){textcode = "Изморозь";location_code = 600;}
     if(weathercode == 51){textcode = "Легкая морось";location_code = 300;}
     if(weathercode == 53){textcode = "Умеренная морось";location_code = 300;}
     if(weathercode == 55){textcode = "Плотная морось";location_code = 300;}
     if(weathercode == 56){textcode = "Легкая ледяная морось";location_code = 300;}
     if(weathercode == 57){textcode = "Плотная ледяная морось";location_code = 300;}
     if(weathercode == 61){textcode = "Слабый дождь";location_code = 300;}
     if(weathercode == 63){textcode = "Умеренный дождь";location_code = 300;}
     if(weathercode == 65){textcode = "Сильный дождь";location_code = 300;}
     if(weathercode == 66){textcode = "Ледяной легкий дождь";location_code = 300;}
     if(weathercode == 67){textcode = "Ледяной сильный дождь";location_code = 300;}
     if(weathercode == 71){textcode = "Легкий снегопад";location_code = 601;}
     if(weathercode == 73){textcode = "Умеренный снегопад";location_code = 601;}
     if(weathercode == 75){textcode = "Сильный снегопад";location_code = 601;}
     if(weathercode == 77){textcode = "Снежные зерна";location_code = 601;}
     if(weathercode == 80){textcode = "Ливнь слабый";location_code = 313;}
     if(weathercode == 81){textcode = "Ливень умеренный";location_code = 313;}
     if(weathercode == 82){textcode = "Ливень сильный";location_code = 313;}
     if(weathercode == 85){textcode = "Слабый снег";location_code = 601;}
     if(weathercode == 86){textcode = "Сильный снег";location_code = 601;}
     if(weathercode == 95){textcode = "Слабая гроза";location_code = 200;}
     if(weathercode == 96){textcode = "Гроза со слабым градом";location_code = 200;}
     if(weathercode == 99){textcode = "Гроза с сильным градом";location_code = 200;}

     if(weathercode1 == 0){textcode1 = "Ясно";coded1 = 800;}
     if(weathercode1 == 1){textcode1 = "Преимущественно ясно";coded1 = 801;}
     if(weathercode1 == 2){textcode1 = "переменная облачность";coded1 = 802;}
     if(weathercode1 == 3){textcode1 = "плотная облачность";coded1 = 804;}
     if(weathercode1 == 45){textcode1 = "Туман";coded1 = 701;}
     if(weathercode1 == 48){textcode1 = "Изморозь";coded1 = 600;}
     if(weathercode1 == 51){textcode1 = "Легкая морось";coded1 = 300;}
     if(weathercode1 == 53){textcode1 = "Умеренная морось";coded1 = 300;}
     if(weathercode1 == 55){textcode1 = "Плотная морось";coded1 = 300;}
     if(weathercode1 == 56){textcode1 = "Легкая ледяная морось";coded1 = 300;}
     if(weathercode1 == 57){textcode1 = "Плотная ледяная морось";coded1 = 300;}
     if(weathercode1 == 61){textcode1 = "Слабый дождь";coded1 = 300;}
     if(weathercode1 == 63){textcode1 = "Умеренный дождь";coded1 = 300;}
     if(weathercode1 == 65){textcode1 = "Сильный дождь";coded1 = 300;}
     if(weathercode1 == 66){textcode1 = "Ледяной легкий дождь";coded1 = 300;}
     if(weathercode1 == 67){textcode1 = "Ледяной сильный дождь";coded1 = 300;}
     if(weathercode1 == 71){textcode1 = "Легкий снегопад";coded1 = 601;}
     if(weathercode1 == 73){textcode1 = "Умеренный снегопад";coded1 = 601;}
     if(weathercode1 == 75){textcode1 = "Сильный снегопад";coded1 = 601;}
     if(weathercode1 == 77){textcode1 = "Снежные зерна";coded1 = 601;}
     if(weathercode1 == 80){textcode1 = "Ливнь слабый";coded1 = 313;}
     if(weathercode1 == 81){textcode1 = "Ливень умеренный";coded1 = 313;}
     if(weathercode1 == 82){textcode1 = "Ливень сильный";coded1 = 313;}
     if(weathercode1 == 85){textcode1 = "Слабый снег";coded1 = 601;}
     if(weathercode1 == 86){textcode1 = "Сильный снег";coded1 = 601;}
     if(weathercode1 == 95){textcode1 = "Слабая гроза";coded1 = 200;}
     if(weathercode1 == 96){textcode1 = "Гроза со слабым градом";coded1 = 200;}
     if(weathercode1 == 99){textcode1 = "Гроза с сильным градом";coded1 = 200;}
      if (printCom) { 
  ...
  if (displayForecastNow) {
    if (temperaturedarc > 0) {
      texttemp = "+" ;
      weatherString +=  "Сейчас в " + String(gorod) + ":" + " температура " + texttemp + String(temperaturedarc, 1) + "\260" + "С";
       }else{
      weatherString +=  "Сейчас в " + String(gorod) + ":" + " температура " + String(temperaturedarc, 1) + "\260" + "С";
       }
