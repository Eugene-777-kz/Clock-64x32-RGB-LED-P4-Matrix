void WetMap() {
  ...
  http.end();
   ...
   if(temp_2 > temp_1){tempmax = temp_2;tempmin = temp_1;}
   if(temp_1 > temp_2){tempmax = temp_1;tempmin = temp_2;}
  ...
  if (displayForecastNow) {
    if (temper > 0) {
      texttemp = "+" ;
      weatherString +=  "Сейчас в " + String(gorod) + ":" + " температура " + texttemp + String(temper, 1) + "\260" + "С";
       }else{
      weatherString +=  "Сейчас в " + String(gorod) + ":" + " температура " + String(temper, 1) + "\260" + "С";
       }
