...

{
           ...
           matrix.setTextColor(myCOLORA[e][0]);
            ...
            if (weti == 2) {sensors_event_t temp;aht_temp->getEvent(&temp);  matrix.print ("+");matrix.println(String(temp.temperature + CorTemp, 0) + "\260" + "C");}    
            ...
            if (wety == 2) {sensors_event_t humidity;aht_humidity->getEvent(&humidity);matrix.print(String(humidity.relative_humidity + CorHum, 0));matrix.println ("%");}
