bool loadConfig() {                                                
  ...
  nslist1 = doc["nslist1"].as<String>();
  nslist2 = doc["nslist2"].as<String>();
  nslist3 = doc["nslist3"].as<String>();
  nslist4 = doc["nslist4"].as<String>();
  nslist5 = doc["nslist5"].as<String>();
  nslist6 = doc["nslist6"].as<String>();
  nslist7 = doc["nslist7"].as<String>();
  nslist8 = doc["nslist8"].as<String>();
  list1 = doc["list1"];//
  list2 = doc["list2"];//
  list3 = doc["list3"];//
  list4 = doc["list4"];//
